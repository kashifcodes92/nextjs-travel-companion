  ...
  return (
    ...
    >
      <Flex justifyContent={'space-between'} width='full'>
        ...
        rounded='lg'
        src={
          place.photo ? place.photo.images.large.url : 'https://p1.pxfuel.com/preview/127/270/362/restaurant-table-cutlery-fork.jpg'
        }
      />
      </Flex>
      {/* address */}
      {
        place?.address && (
          <Flex alignItems={'center'} width={'fit-content'} px={1} my={2}>
